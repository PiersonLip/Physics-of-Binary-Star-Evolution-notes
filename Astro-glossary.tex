...
name={Degenerate},
description={Matter which is under the effects of degeneracy. This is very commonly seen in neutron stars, as degeneracy pressure is what keeps them from collasping. \\ 
For more see \gls{pauli-exclusion-principle}
}
}

\newglossaryentry{pauli-exclusion-principle}{
name={Pauli exclusion principle},
description={The property of matter that two indentical particles with half integer spins (ferminons) cannot occupy the same quantum state. \\
