...
\end{quoteBox}
This means that in systems of very dense matter, the system \textit{\textbf{{cannot reach homogeneity}}}, and thus will actually have a inherent pressure. This pressure can prevent collapse due to gravity in various high dense objects (compact objects in astronomy).
